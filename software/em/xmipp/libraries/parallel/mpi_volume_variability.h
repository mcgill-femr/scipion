 ...
 ***************************************************************************/
#ifndef MPI_VOLUME_VARIABILITY_H_
#define MPI_VOLUME_VARIABILITY_H_

#include "xmipp_mpi.h"
#include <data/args.h>
#include <reconstruction/volume_variability.h>
...
class ProgMPIVolVariability: public ProgVolVariability, public XmippMpiProgram
{
public:
    ...
    /** Empty constructor */
    ProgMPIVolVariability()
    {}

    /*  constructor ------------------------------------------------------- */
    ProgMPIVolVariability(int argc, char *argv[]);

    /* constructor providing an MpiNode
     * this is useful for using this programs from others
     */
    ProgMPIVolVariability(MpiNode * node);
...
//@}
//end of class MPI volume variability

#endif /* MPI_VOLUME_VARIABILITY_H_ */
