...
#ifndef __VOLUME_VARIABILITY_H
#define __VOLUME_VARIABILITY_H
...
class ProgVolVariability : public ProgReconsBase
{
public:
    /** Filenames */
...
public: // Internal members
    ...
    // Fourier Transform of the input volume which is the expected or average volume
    MultidimArray< std::complex<double> > fftVin;
